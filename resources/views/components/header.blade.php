...
<nav id="mobile-sidebar" class="z-40 fixed top-0 right-0 h-screen bg-white shadow-sidebar w-11/12 hidden px-6">
    ...
    <ul class="text-gray-500 flex gap-3 flex-col mt-28">
        <li><a href="">Home</a></li>
        <li><a href="{{ route('form.create') }}">Form</a></li>
        ...
        <li><a href="{{ route('food.index') }}">Foods</a></li>
...
<nav class="bg-white flex sticky top-0 md:hidden justify-between px-6 pb-6">
<a href="">
<img src="{{ asset('assets/biru.png') }}" class="w-12" alt="">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
    ...
    <nav class="hidden md:flex bg-white sticky top-0 mx-auto p-4 justify-between items-center border-b-2 border-gray-200  px-44">
